...
describe('provider/element-templates - CustomProperties', function() {
  ...
  describe('validation on text fields', function() {
    ...
    it('should validate minLength', async function() {
      ...
      const entry = findEntry('custom-entry-com.validated-text-areas.Task-1', container),
            input = findTextarea(entry);
    ...
    it('should validate maxLength', async function() {
      ...
      const entry = findEntry('custom-entry-com.validated-text-areas.Task-2', container),
            input = findTextarea(entry);
    ...
    it('should validate pattern (String)', async function() {
      ...
      const entry = findEntry('custom-entry-com.validated-text-areas.Task-3', container),
            input = findTextarea(entry);
    ...
    it('should validate pattern (String + Message)', async function() {
      ...
      const entry = findEntry('custom-entry-com.validated-text-areas.Task-4', container),
            input = findTextarea(entry);
    ...
    it('should validate pattern (Integer)', async function() {
      ...
      const entry = findEntry('custom-entry-com.validated-text-areas.Task-5', container),
            input = findTextarea(entry);
